    ...
    <div className="mx-4 md:mx-14 mt-12 md:mt-20" style={div2Style}>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center">
        <div className="w-full md:w-1/2 p-4 md:p-12">
          <h3 className="text-left text-lg font-bold">Why Choose Us</h3>
          ...
          <button className="bg-orange flex items-center text-white font-bold rounded py-3 px-8 my-4">
        ...
        <div className="w-full md:w-1/2 block p-4 md:p-12">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-2/3">
              <h2 className="text-lg font-bold text-left  my-2">Cross Country Drive</h2>
              <p className="text-gray-dark text-left ">
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-2/3">
              <h2 className="text-lg font-bold text-left  my-2">All Inclusive Pricing</h2>
              <p className="text-gray-dark text-left ">
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-2/3">
              <h2 className="text-lg font-bold text-left  my-2">No Hidden Charges</h2>
              <p className="text-gray-dark text-left ">
