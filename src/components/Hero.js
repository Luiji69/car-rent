    ...
    <div>
      <div className="container mx-auto flex flex-col md:flex-row py-2">
        <div className="w-full md:w-1/2 p-8 py-16">
          <h3 className="text-black text-lg md:text-left md:ml-8 font-bold">
            Plan your trip now
          </h3>
          <h1 className="text-6xl font-bold mt-2 md:text-left md:ml-8 py-4">
            Save <span className="text-orange">big</span> with our car rental
          </h1>
          <p className="text-gray-dark mt-4 md:text-left md:ml-8">
            Rent the car of your dreams. Unbeatable prices, unlimited miles,
            flexible pick-up options and much more.
          </p>
          <div className="mt-8 flex flex-col items-center md:flex-row md:items-center md:ml-8">
            <button className="bg-orange text-white rounded px-8 py-4 flex items-center mb-4 md:mb-0 md:mr-4">
              Book Ride <CheckCircleOutlined className="ml-2" />
            </button>
            <button className="bg-black text-white rounded px-8 py-4 flex items-center">
