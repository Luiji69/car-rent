        ...
        <div className="flex flex-col md:flex-row justify-center items-center">
          <div className="w-full md:w-1/2 p-4 md:p-12">
            ...
            <div className="flex flex-col ">
              ...
              <a
                ...
                href="https://www.google.com/maps/d/u/0/viewer?mid=1vDcZa0Q_gUUiXgLPhCfzwQVDnY4&hl=en_US&ll=33.84073746204978%2C10.895412000000029&z=11"
              >
          ...
          <div className="w-full md:w-1/2 p-4 md:p-12">
            <form className='flex flex-col' action="">
                ...
                <input id='input1' required placeholder='Eg. Jhon Doe' className='bg-gray-light rounded h-12 p-4' type="text" />
                <label className='text-left font-bold mt-8' htmlFor="input2">Email <span className='text-red-500'>*</span> </label>
                <input id='input2' required placeholder='jhondoe@gmail.com' className='bg-gray-light rounded h-12 p-4' type="email" />
